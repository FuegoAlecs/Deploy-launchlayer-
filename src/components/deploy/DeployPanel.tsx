  ...
  React.useEffect(() => {
      const estimate = async () => {
          ...
          try {
              ...
              console.log("Gas estimation failed (likely incorrect network or invalid args):", err);
          }
      };
  ...
  const handleDeploy = async () => {
      ...
      try {
          ...
          if (environment === 'injected') {
              ...
              addLog(`Transaction sent successfully. Hash: ${data.txHash}`, 'success', 'Deploy');
              address = "Deployed (Check Explorer)";
